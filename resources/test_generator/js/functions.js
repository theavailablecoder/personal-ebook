...
function shuffle_array(types) {
	...
	if (types.indexOf("Multiple choice questions") != -1)
		_types[0] = "Multiple choice questions";
	else _types[0] = "";
	...
	if (types.indexOf("Match the Following") != -1)
		_types[3] = "Match the Following";
	else _types[3] = "";

	if (types.indexOf("Short answer type questions") != -1)
		_types[4] = "Short answer type questions";
	else _types[4] = "";

	if (types.indexOf("Answer the following questions") != -1)
		_types[5] = "Answer the following questions";
	else _types[5] = "";

	if (types.indexOf("Circle and underline") != -1)
		_types[6] = "Circle and underline";
	else _types[6] = "";

	if (types.indexOf("Activity and puzzle") != -1)
		_types[7] = "Activity and puzzle";
	else _types[7] = "";

	if (types.indexOf("Comprehension questions") != -1)
		_types[8] = "Comprehension questions";
	else _types[8] = "";

	if (types.indexOf("Write True or False") != -1)
		_types[9] = "Write True or False";
	else _types[9] = "";

	if (types.indexOf("Application based qustions") != -1)
		_types[10] = "Application based qustions";
	else _types[10] = "";

	if (types.indexOf("Higher Order Thinking Skills") != -1)
		_types[11] = "Higher Order Thinking Skills";
	else _types[11] = "";
	
	if (types.indexOf("Statement based question") != -1)
		_types[12] = "Statement based question";
	else _types[12] = "";
	
	if (types.indexOf("Assertion and reasoning question") != -1)
		_types[13] = "Assertion and reasoning question";
	else _types[13] = "";

	if (types.indexOf("Category Image Based Questions") != -1)
		_types[14] = "Category Image Based Questions";
	else _types[14] = "";
